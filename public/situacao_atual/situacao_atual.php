...
<?php /*----------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        <script type="text/javascript">
            ...
            var mapa,
                ...
                geo_terrama = "https:<?= $url_qmd ?>/terrama2q/geoserver/ows"
                geo_meteorologia = "https:<?= $url_qmd ?>/firerisk/geoserver/wms"
            ...
            function changeTable(unidade, tmp, tp) {
                ...
                $(id_obj).attr("src", tp == "mapa" ? ("mapas.php?tmp=" + tmp + "&un=" + un) : ("<?= $url_base ?>focos_" + un + "_" + tmp + label_tp + ".html?_=<?= $date ?>"));
            }
