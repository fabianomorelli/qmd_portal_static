...
arquivos = [
    "%s/focos_paises_anual_7anos.html"%(PATH),
    "%s/focos_paises_anual_estendida.html"%(PATH),
]
...
for arquivo in arquivos:
    ...
    titulo = f"Tabela anual comparativa de países - últimos anos no intervalo de 01/Jan até {DIA_ONTEM}/{MES_NAME}"
