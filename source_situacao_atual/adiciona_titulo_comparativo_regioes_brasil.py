...
arquivos = [
    "%s/focos_regiao_brasil_anual_7anos.html"%(PATH),
    "%s/focos_regiao_brasil_anual_estendida.html"%(PATH),
]
...
for arquivo in arquivos:
    ...
    titulo = f"Tabela anual comparativa de regiões do Brasil - últimos anos no intervalo de 01/Jan até {DIA_ONTEM}/{MES_NAME}"
