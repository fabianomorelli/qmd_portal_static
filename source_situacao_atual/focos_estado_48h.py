...
ARQUIVO_SAIDA = (
    "%s/focos_estado_48h.html"%(get.returnPath())
)
...
stats[(stats.qtd >= 15) & (stats.qtd < 50)].plot(
    color='#f48639', ax=base, edgecolor='black', linewidth=2
)
stats[(stats.qtd >= 5) & (stats.qtd < 15)].plot(
    color='#fbcfa7', ax=base, edgecolor='black', linewidth=2
)
stats[(stats.qtd >= 0) & (stats.qtd < 5)].plot(
