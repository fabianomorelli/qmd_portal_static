...
ARQUIVO_SAIDA = "%s/focos_estado_mes_atual.html"%(get.returnPath())
...
stats[(stats.qtd >= 7000)].plot(
    color='#541817', ax=base, edgecolor='black', linewidth=2
)
stats[(stats.qtd >= 3000) & (stats.qtd < 7000)].plot(
    color='#a02d19', ax=base, edgecolor='black', linewidth=2
)
stats[(stats.qtd >= 1000) & (stats.qtd < 3000)].plot(
    color='#c14336', ax=base, edgecolor='black', linewidth=2
)
stats[(stats.qtd >= 500) & (stats.qtd < 1000)].plot(
...
stats[(stats.qtd >= 0) & (stats.qtd < 100)].plot(
