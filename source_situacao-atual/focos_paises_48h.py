...
ARQUIVO_SAIDA = (
    "%s/focos_paises_48h.html"%(get.returnPath())
)
...
paises_stats[(paises_stats.qtd >= 2500)].plot(
    color='#541817', ax=base, edgecolor='black', linewidth=2
)
paises_stats[(paises_stats.qtd >= 1000) & (paises_stats.qtd < 2500)].plot(
...
paises_stats[(paises_stats.qtd >= 250) & (paises_stats.qtd < 500)].plot(
    color='#f05b31', ax=base, edgecolor='black', linewidth=2
)
paises_stats[(paises_stats.qtd >= 100) & (paises_stats.qtd < 250)].plot(
    color='#f48639', ax=base, edgecolor='black', linewidth=2
)
paises_stats[(paises_stats.qtd >= 50) & (paises_stats.qtd < 100)].plot(
    color='#fbcfa7', ax=base, edgecolor='black', linewidth=2
)
paises_stats[(paises_stats.qtd >= 0) & (paises_stats.qtd < 50)].plot(
...
html = f"""
  ...
  <body style="text-align: center;">
    ...
    <div><img src="http://queimadas.dgi.inpe.br/queimadas/portal-static/v_paises_focos_48h.png" alt="legenda"></div>
</body>
  </html>
"""
