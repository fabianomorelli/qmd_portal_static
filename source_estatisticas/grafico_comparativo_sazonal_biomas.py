...
for key, value in biomas_dict.items():
            ...
            <div>
                <center>
                    <div style='width: 900px'>
                        <center><div style='font-family: "open_sansregular", Arial, Helvetica, sans-serif;'><big>Comparativo mensal do bioma: <b>%s</b></big></center>
                        <center><div id="comparativo_historico_paises"></center>
                    </div>
                </center>
            </div>
            </div>
    ...
    html_1_semestre = """
            ...
            <div>
                <center>
                    <div style='width: 900px'>
                        <center><div style='font-family: "open_sansregular", Arial, Helvetica, sans-serif;'><big>Comparativo 1º semestre do bioma: <b>%s</b></big></center>
    ...
    html_2_semestre = """
            ...
            <div>
                <center>
                    <div style='width: 900px'>
                        <center><div style='font-family: "open_sansregular", Arial, Helvetica, sans-serif;'><big>Comparativo 2º semestre do bioma: <b>%s</b></big></center>
                        <center><div id="comparativo_historico_paises"></div></center>
                    </div>
                </center>
            </div>
